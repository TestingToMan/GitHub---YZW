...
class Crawler:
    ...
    def save_image(self, rsp_data, word):
        if not os.path.exists("/Users/yangzewei/Crawler_P/" + word):
            os.mkdir("/Users/yangzewei/Crawler_P/" + word)
        # 判断名字是否重复，获取图片长度
        self.__counter = len(os.listdir('/Users/yangzewei/Crawler_P/' + word)) + 1
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                # 保存图片
                urllib.request.urlretrieve(image_info['objURL'], '/Users/yangzewei/Crawler_P/' + word + '/' + str(self.__counter) + str(suffix))
...
if __name__ == '__main__':
    ...
    # crawler.start('美女', 10, 1)  # 抓取关键词为 “美女”，总数为 1 页（即总共 1*60=60 张），开始页码为 2
    crawler.start('苍井空', 3, 1)  # 抓取关键词为 “二次元 美女”，总数为 10 页（即总共 10*60=600 张），起始抓取的页码为 1
